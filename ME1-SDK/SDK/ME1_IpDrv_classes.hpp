...
public:
	...
	unsigned char                                      UnknownData00[0x94];                                      // 0x0A84(0x0094) MISSED OFFSET
...
{
public:
	struct FPointer                                    VoiceEngine;                                              // 0x0084(0x0004) (Const, Native, Transient)
	int                                                MaxLocalTalkers;                                          // 0x0088(0x0004) (Config)
	int                                                MaxRemoteTalkers;                                         // 0x008C(0x0004) (Config)
	unsigned long                                      bIsUsingSpeechRecognition : 1;                            // 0x0090(0x0004) (Config)
	class UOnlineGameInterfaceImpl*                    GameInterfaceImpl;                                        // 0x0094(0x0004)
...
public:
	...
	int                                                LanAnnouncePort;                                          // 0x009C(0x0004) (Const, Config)
	int                                                LanGameUniqueId;                                          // 0x00A0(0x0004) (Const, Config)
	int                                                LanPacketPlatformMask;                                    // 0x00A4(0x0004) (Const, Config)
	float                                              LanQueryTimeLeft;                                         // 0x00A8(0x0004)
	float                                              LanQueryTimeout;                                          // 0x00AC(0x0004) (Config)
	struct FPointer                                    LanBeacon;                                                // 0x00B0(0x0004) (Const, Native, Transient)
	struct FPointer                                    SessionInfo;                                              // 0x00B4(0x0004) (Const, Native, Transient)
	struct FScriptDelegate                             __OnFindOnlineGamesComplete__Delegate;                    // 0x00B8(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateOnlineGameComplete__Delegate;                   // 0x00C4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnDestroyOnlineGameComplete__Delegate;                  // 0x00D0(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnJoinOnlineGameComplete__Delegate;                     // 0x00DC(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnRegisterPlayerComplete__Delegate;                     // 0x00E8(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnUnregisterPlayerComplete__Delegate;                   // 0x00F4(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnStartOnlineGameComplete__Delegate;                    // 0x0100(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnEndOnlineGameComplete__Delegate;                      // 0x010C(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnArbitrationRegistrationComplete__Delegate;            // 0x0118(0x000C) (NeedCtorLink)
	struct FScriptDelegate                             __OnGameInviteAccepted__Delegate;                         // 0x0124(0x000C) (NeedCtorLink)
...
// 0x001C (0x4F98 - 0x4F7C)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x1C];                                      // 0x4F7C(0x001C) MISSED OFFSET
...
{
public:
	unsigned long                                      AllowPlayerPortUnreach : 1;                               // 0x0120(0x0004) (Config)
	unsigned long                                      UnknownData00 : 31;                                       // 0x0120(0x0001)
	unsigned long                                      LogPortUnreach : 1;                                       // 0x0124(0x0004) (Config)
	unsigned char                                      UnknownData01[0x14];                                      // 0x0128(0x0014) MISSED OFFSET
